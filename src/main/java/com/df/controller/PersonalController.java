...
public class PersonalController {
    ...
    private void updateFile(User user) throws Exception {
        ...
        PrintUtils.updateTicketFile(ticketPath,ticketSheet,user);
        PrintUtils.updateFubenFile(fubenPath,fubenSheet,user);
    }
}
